<?php
namespace frontend\web\payment\classes\stub;

class PaymentGatewayGoldenpayYii {
    ...
    public function getPaymentKeyJSONRequest($amount, $lang, $cardType, $description, $for) {
        $params = array(
