                        ...
                        var radioOutput = function () {
                            ...
                            radio.on('click.styler', function () {
                                if (!radio.is('.disabled')) {
									if (el.is(':checked') && $(".ok_page").length>0 ){
                            ...
                            function doSelect() {
                                ...
                                var selectbox =
                                        $('<div' + att.id + ' class="jq-selectbox jqselect' + att.classes + '" style="display: inline-block; position: relative; z-index:' + opt.singleSelectzIndex + '">' +
                                                '<div class="jq-selectbox__select ' + att.classes + '"' + att.title + ' style="position: relative">' +
                                ...
                                var dropdown =
                                        $('<div class="jq-selectbox__dropdown ' + att.classes + '" style="position: absolute">' +
                                                searchHTML +
                                                '<ul class="h280" style="position: relative; list-style: none; overflow: auto; overflow-x: hidden">' + list + '</ul>' +
                                                '</div>');
