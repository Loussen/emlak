    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'header'=>'Başlıq',
                'value' =>function($data){
                        $val='title_'.Yii::$app->params["defaultLanguage"];
                        return $data->$val;
                    }
            ],
            [
                'attribute' => 'parent_id',
                'filter' => $modelName::getParents(),
                'value' => function($data){ if(isset($data->getParents()[$data->parent_id])) return $data->getParents()[$data->parent_id];},
            ],
            [
