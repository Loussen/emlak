...
<div class="categories-form">
    ...
    <div class="ui-element-container">
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <?php //echo $form->field($model, 'category_id')->dropDownList(Categories::getCategories()); ?>
            <?php //echo $form->field($model, 'author_id')->dropDownList(Authors::getAuthors()); ?>
			<?php echo  $form->field($model, 'tags')->textInput(); ?>
			<?php echo $form->field($model, 'desc')->widget(Kindeditor::className(),[
                        'clientOptions'=>[
                            'allowFileManager'=>'true',
                            'allowUpload'=>'true',
                            'langType' => 'en',
