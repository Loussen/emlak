    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'raw',
                'value' => function($data) {
                        return Html::a('<i class="fa fa-circle white"></i> '.MyFunctions::getStatus($data->status),['albums-inner/status/'.$data->id],['class'=>'btn '.MyFunctions::getStatusTemplate($data->status).' btn-sm']);
                    },
            ],
            [
