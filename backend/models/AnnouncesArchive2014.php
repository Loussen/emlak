...
/**
 * This is the model class for table "announces_archive_2014".
 *
 * @property integer $id
 ...
 */
class AnnouncesArchive2014 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['email', 'mobile', 'name', 'cover', 'mark', 'address', 'google_map', 'text', 'reasons','panarama'], 'string'],
            [['price', 'space'], 'number'],
