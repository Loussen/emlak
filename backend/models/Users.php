...
class Users extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['password', 'image', 'thumb', 'mobile', 'address','title_','keywords_'], 'string', 'max' => 255],
            [['desc_','archive_ann'], 'string'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'desc_' => 'Description',
            'keywords_' => 'Keywords',
            'archive_ann' => 'Görsənən arxiv elanlar',
        ];
    }
