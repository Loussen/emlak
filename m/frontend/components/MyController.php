...
class MyController extends Controller {
	...
	public $siteUrl='http://emlak.az';
	public $mobileSiteUrl='http://m.emlak.az';
	public $getImageUrl='http://emlak.az/images';
	public $siteTitle;
	...
	public $ti1; public $ti2; public $ti3; public $ti4; public $ti5; public $ti6; public $ti7; public $ti8; public $ti10; public $tix; public $yasayis; public $rtix;
    ...
    $ts10=Yii::$app->db->createCommand("select count(id) from announces where property_type=10 and status=1 and announce_type=1 and country=1")->queryScalar();
        ...
        $rtix=Yii::$app->db->createCommand("select count(id) from announces where status=1 and announce_type=2 and rent_type=1")->queryScalar();
...
$cacheName2='userAnnounces4_rows_'.intval(Yii::$app->session["logged_id"]); $this->userAnnounces4_rows=Yii::$app->cache->get($cacheName2);	// silinmiw_rows
    ...
    public function titleGenerator($lang,$announce_type,$property_type,$space,$room_count,$mark,$settlement,$metro,$region,$city,$address,$format='not_full'){
    ...
    public function locationsGenerator($marks,$to='profil_elanlar'){
        ...
        if($marks!=''){
            ...
            foreach($marks as $mark){
				if($to=='profil_elanlar') $return.='<a href="'.Url::to(['elanlar/?ann_type=3&selected_marks[]='.$mark]).'">'.$this->marks[$mark].'</a>';
                else if($to=='elan_view') $return.='<h3><a href="'.Url::to(['elanlar/?ann_type=3&selected_marks[]='.$mark]).'">'.$this->marks[$mark].'</a><h3>';
                elseif($to=='backend') $return.=$this->marks[$mark].', ';
            }
        }
