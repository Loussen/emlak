    ...
    public function actionForgot(){
        ...
        else
        {
            ...
            $mesaj=Yii::t('app','lang121').'<br /> <br />
                    <a href="http://emlak.az/qeydiyyat/repass?code='.$code.'&answer=1" target="_blank">'.Yii::t('app','lang112').'</a><br />
                    <a href="http://emlak.az/qeydiyyat/repass?code='.$code.'&answer=0" target="_blank">'.Yii::t('app','lang113').'</a>';
            //
            return 'success---'.Yii::$app->mailer->compose()->setTo($email)->setFrom([$this->info_contact[0]["email"] => 'Emlak.az'])->setSubject(Yii::t('app','lang122'))->setTextBody($mesaj)->send();
        }
    }
