...
class YasayisKompleksleriController extends MyController
{
    ...
    {
        $kompleksler=Apartments::find()->where(['status'=>1])->orderBy('position')->asArray()->all();
    ...
    public function actionView($id)
    {
		...
		Yii::$app->view->registerMetaTag(['name' => 'og:image','content' => $this->siteUrl.'/images/'.$images[0]["image"]]);
