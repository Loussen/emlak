...
class Apartments extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['title_'.Yii::$app->params["defaultLanguage"], 'short_text_'.Yii::$app->params["defaultLanguage"], 'email', 'mobile', 'status'], 'required'],
            [['album_id', 'status','position','album_id2'], 'integer'],
