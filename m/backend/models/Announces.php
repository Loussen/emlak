...
class Announces extends \yii\db\ActiveRecord
{
    ...
    public function rules(){
        return [
            ...
            [['price', 'space'], 'number'],
            [['room_count', 'rent_type', 'property_type', 'announce_type', 'country', 'city', 'region', 'settlement', 'metro', 'floor_count', 'current_floor', 'repair', 'document', 'view_count', 'announcer', 'status', 'insert_type', 'urgently', 'sort_search', 'sort_foward', 'sort_package', 'sort_premium', 'announce_date', 'visitors_count', 'create_time'], 'integer'],
            [['text'], 'string'],
