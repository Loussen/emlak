...
/**
 * This is the model class for table "announces_ended".
 *
 * @property integer $id
 ...
 */
class AnnouncesEnded extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
