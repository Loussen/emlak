    ...
    protected function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model, $key) {
                ...
                return Html::a('<span class="glyphicon glyphicon-eye-open white"></span>', $url, $options);
            };
        }
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key) {
                ...
                return Html::a('<span class="glyphicon glyphicon-pencil white"></span>', $url, $options);
            };
        }
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                ...
                return Html::a('<span class="glyphicon glyphicon-trash white"></span>', $url, $options);
            };
        }
        if (!isset($this->buttons['up'])) {
            $this->buttons['up'] = function ($url, $model, $key) {
                ...
                return Html::a('<i class="fa fa-chevron-up green"></i>', $url, $options);
            };
        }
        if (!isset($this->buttons['down'])) {
            $this->buttons['down'] = function ($url, $model, $key) {
                ...
                return Html::a('<i class="fa fa-chevron-down red"></i>', $url, $options);
            };
        }
    }
