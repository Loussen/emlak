...
<div class="categories-index">
    ...
    foreach($announces as $announce)
    {
        ...
        echo '<div style="border: none;width:'.$bigWidth.'px;" class="main_div" data-idi="'.$announce["id"].'" id="ann_block_'.$announce["id"].'">
            ...
            <a href="javascript:void(0);" target="_blank" title="'.date("d.m.Y H:i",$announce["announce_date"]).'"><input class="btn btn-success btn-sm" value="Arxiv" type="button" style="height: 18px;line-height: 7px;"></a>
            </div>
			...
			<div class="w60 '.((in_array(11,$reasons))?'lightpink':'').'"><div class="reasons_x" r="10">x</div>'.$announce["current_floor"].' / '.$announce["floor_count"].'</div>
