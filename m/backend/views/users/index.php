...
<div class="categories-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
			...
			[
                'attribute' => 'premium',
				'header' =>'Əmlakçılar bölməsində',
                'options' => ['width'=>150],
				'value' =>function($data){
					if($data->premium>time()) return floor(($data["premium"]-time())/86400).' gün '.(floor(($data["premium"]-time())/3600)%24).' saat '.(floor(($data["premium"]-time())/60)%60).' dəqiqə';
					else return '0 gün';
				}
            ],
            'name',
