            ...
            <div class="sidey">
                ...
                <div style="" class="side-nav">
                    <div class="side-nav-block">
                        <h4><a href="<?=Url::to(['announces/index?cacheUpdate=1']); ?>">Cache update</a></h4>
						...
						echo Menu::widget([
                            'items' => [
								...
								['label' => '<i class="fa fa-bolt gray"></i> Təcili elanlar <span class="badge badge-gray pull-right '.$classSFw.'" style="margin-right: 12px;">'.$this->context->newSearchFoward.'</span>', 'url' => ['announces/index/?status=6']],
								['label' => '<i class="fa fa-search gray"></i> Axtarışda irəli çəkilənlər <span class="badge badge-gray pull-right '.$classUrg.'" style="margin-right: 12px;">'.$this->context->newUrgently.'</span>', 'url' => ['announces/index/?status=8']],
