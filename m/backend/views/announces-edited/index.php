...
<div class="categories-index">
    ...
    foreach($editedAnnounces as $announce)
    {
        ...
        echo '<div style="border: none;width:'.$bigWidth.'px;" class="main_div" data-idi="'.$announce["announce_id"].'" id="ann_block_'.$announce["announce_id"].'">
            ...
            <a href="javascript:void(0);" target="_blank"><input class="btn btn-success btn-sm" value="Arxiv" type="button" style="height: 18px;line-height: 7px;"></a>
            </div>
            ...
            <div class="w80 '.((in_array(2,$reasons))?'lightpink':'').'"><div class="reasons_x" r="2">x</div>'.$this->context->countries[$realAnnounces[$announce["announce_id"]]["country"]].$s2.'</div>
            ...
            <div class="w100 '.((in_array(23,$reasons))?'lightpink':'').'"><div class="reasons_x" r="23">x</div>'.$s23.'</div>
                <div id="modalMap'.$announce["announce_id"].'" class="myModal">
                    ...
                    <img src="http://maps.google.com/maps/api/staticmap?center='.$realAnnounces[$announce["announce_id"]]["google_map"].'&zoom=14&size=530x230&maptype=roadmap&sensor=false&language=&markers=color:red|label:none|'.$realAnnounces[$announce["announce_id"]]["google_map"].'" alt="" /><br /><hr />
                    <span class="blue">Yeni:</span><br />
                    <img src="http://maps.google.com/maps/api/staticmap?center='.$announce["google_map"].'&zoom=14&size=530x230&maptype=roadmap&sensor=false&language=&markers=color:red|label:none|'.$announce["google_map"].'" alt="" /><hr />
                    <input class="btn btn-success btn-sm closeMyModal" value=" &nbsp; Bağla &nbsp; " type="button">
                </div>
