    ...
    echo DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'label'=>'Şəkil',
                'format'=>'raw',
                'value'=>($model->image!=null && is_file(MyFunctions::getImagePath().'/'.$model->image))?HTML::img(MyFunctions::getImageUrl().'/'.$model->image,['width'=>100]):'',
            ],
            [
                'attribute'=>'thumb',
                'label'=>'Şəkil (Thumb)',
            ...
            'post_count',
            [
                'attribute'=> 'last_post_time',
                'value' => date("Y-m-d H:i",$model->last_post_time),
            ],
            'slug',
            [
                'attribute'=>'status',
