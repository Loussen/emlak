    ...
    <div class="ui-element-container">
        ...
        <div id="myTabContent" class="tab-content">
            ...
            foreach(Yii::$app->params['languages'] as $key=>$lang)
            {
                ...
                $field_name='about_project_'.$key;
                $field_name2='about_company_'.$key;
                echo DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            ...
                            'value' => Html::decode($model->$field_name2),
                        ],
                        'google_map',
                        'price',
                        'email',
                        ...
                        [
                            ...
                            'label'=>'Logo',
                            'format'=>'raw',
                            'value'=>($model->logo!=null && is_file(MyFunctions::getImagePath().'/'.$model->logo))?HTML::img(MyFunctions::getImageUrl().'/'.$model->logo,['width'=>70]):'',
                        ],
                        'slug',
                        [
                            'attribute'=>'status',
