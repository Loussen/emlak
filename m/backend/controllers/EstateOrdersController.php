...
use backend\models\EstateOrdersSearch;
...
class EstateOrdersController extends MyController
{
    public $modelName='backend\models\EstateOrders';
    ...
    {
        $searchModel = new EstateOrdersSearch();
